...
namespace BankingTests.BankAccountTests
{
    public class BankAccountBonusCalculatorInteractionTests
    {
        ...
        public void BonusCalculatorIsUsedProperly()
        {
            ...
            var account = new BankAccount(stubbedBonusCalculator.Object, new Mock<INarcOnWithdrawals>().Object);
            var openingBalance = account.GetBalance();
            var amountToDeposit = 53.25M;

            stubbedBonusCalculator.Setup(x => x.GetDepositBonusFor(openingBalance, amountToDeposit)).Returns(42m);
